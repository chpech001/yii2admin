...
<div class="area">
    ...
    <div class="areatit">联系我们</div>
    <div class="areabd">
        <?php 
        $html = curl_get('http://news.4399.com/haoyoukb/single_haoyoukb_contact_wap.html?t='.time());
        echo Hykb::gbk2Utf8($html);
        ?>
    </div>
...
if ( $sc == 1 ) {
    ...
    if (strlen($str) > 500) {
        ...
        $path = $_SERVER['DOCUMENT_ROOT'] . '/contact.html';
        ...
        echo '<a href="http://m.3839.com/contact.html">生成成功</a>';
    }
}
