...
<head>
    <meta charset="UTF-8">
	<?php if($type=='recent'){?>
    <title>好游快爆游戏单_最新手机游戏合集-好游快爆app</title>
    <meta name="keywords" content="最新游戏合集,最新手游合集,好游快爆游戏单">
    <meta name="description" content="好游快爆游戏单为您推荐最新手机游戏合集，你能够在这里发现中国风、二次元、科幻风等各种风格的最新游戏合集。来好游快爆，制作属于你自己的的游戏单。">
	<?php }else{?>
	<title>好游快爆游戏单_手机游戏合集-好游快爆app</title>
    <meta name="keywords" content="游戏合集,手游合集,好游快爆游戏单">
    <meta name="description" content="好游快爆游戏单，为广大游戏爱好者们提供了手机游戏合集制作的平台，你能够在这里发现中国风、二次元、科幻风等各种风格的游戏合集，来好游快爆，制作属于你自己的的游戏单。">
	<?php }?>
...
<div class="glist-hd">
    ...
    <div class="glist-sort">
        <a class="<?php if($type=='hot'){echo 'on';}?>" href="<?php echo Comm::get_url('coll','hot',array('view_ishtml'=>1));?>" target="_self">热门</a>
        <a class="<?php if($type=='recent'){echo 'on';}?>" href="<?php echo Comm::get_url('coll','recent',array('view_ishtml'=>1));?>" target="_self">近期</a>
    </div>
</div>
