...
<div class="game-main">
    <div class="inner">
        ...
        <?php
        if ($data['status']==1) {
			echo '<div class="game-down"><a class="down_btn green" href="javascript:void(0);"><span class="ico-down"></span>高速下载</a></div><div class="down-tip">将通过好游快爆高速下载该游戏</div>';
        } else if ($data['status']==4) {
			echo '<div class="game-down"><a class="down_btn yellow" href="javascript:void(0);">预约</a></div><div class="down-tip">将通过好游快爆预约该游戏</div>';			
			
        } else if ($data['status']==3 || $data['status']==5) {
			echo '<div class="game-down"><a class="grey pop_btn" href="javascript:void(0);">敬请期待</a></div>';	
        } else if ($data['status'] == 6) {
			echo '<div class="game-down"><a class="green pop_btn" href="javascript:void(0);">查看详情</a></div>';	
        }
        ?>
		 <ul class="game-otbtn">
		   <?php if ($data['status']==4){?>
            <li><a class="game-order" href="#" onClick="pop2('yzw');return false;">手机号快速预约</a></li>
			<?php }?>
...
<div class="pop pop-spec" style="display: none;" id="yzw">
    ...
    <div class="pcon">
        <p class="pf28">游戏上线后，我们将通过<span>免费短信</span>提醒你</p>
        <div class="mbNum">
